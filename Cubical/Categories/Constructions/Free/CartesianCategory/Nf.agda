...
module _ (Q : ×Quiver ℓq ℓq')
  ...
  -- TODO: this is nice I guess, but I don't think we need this
  ...
  _∘proj₂ var = proj₂ var
  _∘proj₂ (proj₁ ne) = proj₁ $ ne ∘proj₂
  _∘proj₂ (proj₂ ne) = proj₂ $ ne ∘proj₂
  _∘proj₂ (symb f nf) = symb f $ nf ∘PROJ₂
  _∘PROJ₂ (shift ne) = shift $ ne ∘proj₂
  _∘PROJ₂ (pair nf₁ nf₂) = pair (nf₁ ∘PROJ₂) (nf₂ ∘PROJ₂)
  _∘PROJ₂ uniq = uniq
