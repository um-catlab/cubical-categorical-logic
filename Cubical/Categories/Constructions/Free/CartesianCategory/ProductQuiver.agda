...
module _ (ob : Type ℓ) where
  ...
  -- This variant of cartesian signature is more restrictive in order for the
  -- normal forms of the free theory to be more amenable to a hand crafted
  -- description
  --
...
×Quiver'→×Quiver Q .×Quiver.ob = _
×Quiver'→×Quiver Q .×Quiver.×Q = ProductQuiver'→ProductQuiver _ (Q .×Quiver'.×Q)
