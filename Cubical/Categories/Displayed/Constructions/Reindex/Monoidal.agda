-- Reindexing a displayed monoidal cat along a strong monoidal functor
-- inherits a displayed monoidal structure if we have lifts of the
-- associator and unitor.
...
module _ {M : MonoidalCategory ℓC ℓC'}
  ...
  module _ (isoLifts : isIsoFibration P.Cᴰ) where
    ...
    reindex .Cᴰ = Reindex.reindex P.Cᴰ G.F
    reindex .monstrᴰ .tenstrᴰ .unitᴰ = isoLifts P.unitᴰ (invIso G.ε-Iso) .fst
    reindex .monstrᴰ .tenstrᴰ .─⊗ᴰ─ =
      Reindex.introF M.─⊗─
        (reindFNIso (symNatIso G.μ-Iso) isoLifts (P.─⊗ᴰ─ ∘Fᴰ (Reindex.π P.Cᴰ G.F ×Fᴰ Reindex.π P.Cᴰ G.F)))
    reindex .monstrᴰ .αᴰ = {!!}
    reindex .monstrᴰ .ηᴰ = {!!}
    reindex .monstrᴰ .ρᴰ = {!!}
    reindex .monstrᴰ .pentagonᴰ = {!!}
    reindex .monstrᴰ .triangleᴰ = {!!}
