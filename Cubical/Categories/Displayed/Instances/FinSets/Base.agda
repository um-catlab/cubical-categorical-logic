module Cubical.Categories.Displayed.Instances.FinSets.Base where
...
-- Displayed category of sets dependent on a finite set
FinitelyDependentSetsᴰ : Categoryᴰ (FINSET

FINSETᴰ : Categoryᴰ (FINSET {ℓ}) {!!} {!!}
FINSETᴰ = {!!}
