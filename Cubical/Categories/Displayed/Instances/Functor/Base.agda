...
module _ {C : Category ℓC ℓC'}{D : Category ℓD ℓD'}
  ...
  module _ {F G : Functor C D}{α : NatTrans F G}
    ...
    NatTransIsoᴰΣ .ret _ = makeNatTransPathᴰ refl refl
...
module _
  ...
  precomposeFᴰ .F-idᴰ = makeNatTransPathᴰ _ _ _ refl
  precomposeFᴰ .F-seqᴰ fᴰ gᴰ = makeNatTransPathᴰ  _ _ _ refl
...
module _
  ...
  precomposeFⱽ .F-idᴰ = makeNatTransPathᴰ _ _ _ refl
  precomposeFⱽ .F-seqᴰ _ _ = makeNatTransPathᴰ _ _ _ refl
