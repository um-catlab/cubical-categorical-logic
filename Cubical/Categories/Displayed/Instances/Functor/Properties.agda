...
module _ {C : Category ℓC ℓC'}{D : Category ℓD ℓD'}
  ...
  open NatTrans
  open NatTransᴰ
  -- This probably belongs in TotalCategory.Properties but currently that's a circular dependency and also upstream.
  ...
  ∫F-Functor .F-hom (α , αᴰ) .NatTrans.N-hom (f , fᴰ) = ΣPathP (α .N-hom f , αᴰ .N-homᴰ fᴰ)
