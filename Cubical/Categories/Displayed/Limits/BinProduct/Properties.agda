...
module _ {C : Category ℓC ℓC'}{x₁ x₂ : C .ob}
  ...
  private
    ...
    module Cⱽ = Fibers Cᴰ
    module R× cc' = PresheafᴰNotation (BinProductᴰProf Cᴰ prod .Functorᴰ.F-obᴰ {!cc'!})
  ...
  module _ {xᴰ₁ : Cᴰ.ob[ x₁ ]}{xᴰ₂ : Cᴰ.ob[ x₂ ]}
    ...
    BinProductⱽ→BinProductᴰ .elementᴰ .fst = π₁ Cⱽ.⋆ⱽᴰ (lift-π₁ .π)
    BinProductⱽ→BinProductᴰ .elementᴰ .snd = π₂ Cⱽ.⋆ⱽᴰ (lift-π₂ .π)
    ...
    -- β
    BinProductⱽ→BinProductᴰ .universalᴰ .rightInv (f₁ , f₂) (fᴰ₁ , fᴰ₂) = {!!}
