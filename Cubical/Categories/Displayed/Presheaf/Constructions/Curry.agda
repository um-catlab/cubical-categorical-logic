...
module _ {C : Category ℓC ℓC'} (P : Presheaf C ℓP)(Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ') where
  ...
  opaque
    unfolding Element CurryPshᴰ UncurryPshᴰ
...
module _ {C : Category ℓC ℓC'} {P : Presheaf C ℓP}{Q : Presheaf C ℓQ}{Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ'}
  ...
  opaque
    unfolding Element CurryPshᴰ UncurryPshᴰ PshHet→ElementFunctorᴰ
...
module _ {C : Category ℓC ℓC'} {P : Presheaf C ℓP}{Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ'}
  ...
  opaque
    unfolding Element CurryPshᴰ UncurryPshᴰ PshHet→ElementFunctorᴰ Curry-recⱽ
...
module _ {C : Category ℓC ℓC'} {P : Presheaf C ℓP}{Q : Presheaf C ℓQ}{Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ'}
  ...
  opaque
    unfolding Curry-recⱽ Uncurry-recᴰ
...
opaque
  unfolding unfoldElementDefs CurryPshᴰ UncurryPshᴰ
    CurryPshᴰIso Uncurry-recᴰ Uncurry-recⱽ
    CurryPshHom UncurryPshHomⱽ UncurryReind
  unfoldCurryDefs : Unit
  unfoldCurryDefs = tt
