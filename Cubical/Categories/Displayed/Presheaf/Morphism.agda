...
module _ {C : Category ℓC ℓC'} {Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ'}
  ...
  mkOpaquePathsPshHomᴰ : PshHomᴰ α Pᴰ Qᴰ
  mkOpaquePathsPshHomᴰ .N-obᴰ = αᴰ .N-obᴰ
  mkOpaquePathsPshHomᴰ .N-homᴰ {x = x}{y = y}{f = f}{p = p}{fᴰ = fᴰ}{pᴰ = pᴰ} = opq
    where
    opaque
      opq : αᴰ .N-obᴰ (fᴰ Pᴰ.⋆ᴰ pᴰ) Qᴰ.≡[ N-hom α x y f p ] fᴰ Qᴰ.⋆ᴰ αᴰ .N-obᴰ pᴰ
      opq = αᴰ .N-homᴰ
...
module _ {C : Category ℓC ℓC'} {Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ'}
  ...
  mkOpaquePathsPshHomᴰOverOpaquePathsPshHom : PshHomᴰ (mkOpaquePathsPshHom α) Pᴰ Qᴰ
  mkOpaquePathsPshHomᴰOverOpaquePathsPshHom = PshHomEqPshHomᴰ (mkOpaquePathsPshHomᴰ αᴰ) Eq.refl
...
module _ {C : Category ℓC ℓC'} {Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ'}
  ...
  (αᴰ : NatTransᴰ α Pᴰ Qᴰ) where
   ...
   NatTransᴰ→PshHomᴰ : PshHomᴰ (NatTrans→PshHom α) Pᴰ Qᴰ
   NatTransᴰ→PshHomᴰ = mkOpaquePathsPshHomᴰOverOpaquePathsPshHom NatTransᴰ→PshHomᴰ'
...
module _ {C : Category ℓC ℓC'} {Cᴰ : Categoryᴰ C ℓCᴰ ℓCᴰ'}
  ...
  {Pᴰ : Presheafᴰ P Cᴰ ℓPᴰ}
  {Qᴰ : Presheafᴰ Q Cᴰ ℓQᴰ}
  (αᴰ : PshIsoᴰ α Pᴰ Qᴰ) where
  private
    module Pᴰ = PresheafᴰNotation Pᴰ
    module Qᴰ = PresheafᴰNotation Qᴰ

  mkOpaquePathsPshIsoᴰ : PshIsoᴰ α Pᴰ Qᴰ
  mkOpaquePathsPshIsoᴰ .fst = mkOpaquePathsPshHomᴰ (αᴰ .fst)
  mkOpaquePathsPshIsoᴰ .snd .inv = αᴰ .snd .inv
  mkOpaquePathsPshIsoᴰ .snd {x = x}{xᴰ = xᴰ} .rightInv b q = opq
    where
    opaque
      opq : PathP (λ i → Qᴰ.p[ α .nIso x .snd .fst b i ][ xᴰ ])
                   (αᴰ .fst .N-obᴰ (αᴰ .snd .inv b q)) q
      opq = αᴰ .snd .rightInv b q
  mkOpaquePathsPshIsoᴰ .snd {x = x} {xᴰ = xᴰ} .leftInv a p = opq
    where
    opaque
      opq : PathP (λ i → Pᴰ.p[ α .nIso x .snd .snd a i ][ xᴰ ])
        (αᴰ .snd .inv (N-ob (α .trans) x a) (αᴰ .fst .N-obᴰ p)) p
      opq = αᴰ .snd .leftInv a p

  -- TODO implement PshHomEqPshIsoᴰ
  -- mkOpaquePathsPshIsoᴰOverOpaquePathsPshIso : PshIsoᴰ (mkOpaquePathsPshIso α) Pᴰ Qᴰ
  -- mkOpaquePathsPshIsoᴰOverOpaquePathsPshIso .fst = PshHomEqPshHomᴰ (mkOpaquePathsPshIsoᴰ .fst) Eq.refl
  -- mkOpaquePathsPshIsoᴰOverOpaquePathsPshIso .snd .inv = αᴰ .snd .inv
  -- mkOpaquePathsPshIsoᴰOverOpaquePathsPshIso .snd {x = x}{xᴰ = xᴰ} .rightInv b q =
  --   {!!}
  --   where
  --   opaque
  --     opq : PathP
  --             (λ i → Qᴰ.p[ α .nIso x .snd .fst b i ][ xᴰ ])
  --             (αᴰ .fst .N-obᴰ (αᴰ .snd .inv b q)) q
  --     opq = {!!}
  -- mkOpaquePathsPshIsoᴰOverOpaquePathsPshIso .snd .leftInv = {!!}
...
--     module Pᴰ = PresheafᴰNotation Pᴰ
--     module Qᴰ = PresheafᴰNotation Qᴰ
--   ∫PshIso' ∫PshIso : PshIsoᴰ α Pᴰ Qᴰ → PshIso (∫P Pᴰ) (∫P Qᴰ)
...
--   ∫PshIso (αᴰ , αᴰIsPshIsoᴰ) = mkOpaquePathsPshIso (∫PshIso' (αᴰ , αᴰIsPshIsoᴰ))
