...
module Cubical.Categories.Instances.Free.Lambda.ArrowOnly where
    ...
    module _ (Cᴰ : Categoryᴰ LAMBDA/≈ ℓCᴰ ℓCᴰ')
      ...
      module _
        ...
        private
          ...
          module reindexCᴰ = EqReindexProperties Cᴰ QuoFunctor Eq.refl (λ _ _ → Eq.refl)
          Quo*Cᴰ = reindexCᴰ.reindex
