...
module Cubical.Categories.Instances.Free.Monoidal.Coherence where
...
open import Cubical.Categories.Instances.Free.Monoidal.Base as FreeMonoidal
  hiding (rec)
open import Cubical.Categories.Instances.Free.Monoidal.List as LIST
