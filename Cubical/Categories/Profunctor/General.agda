...
PROF*o : (C : Category ℓC ℓC') → ∀ ℓS → (D : Category ℓD ℓD') → Category _ _
PROF*o C ℓS D = FUNCTOR C (FUNCTOR (D ^op) (SET ℓS))

PROFo* : (C : Category ℓC ℓC') → ∀ ℓS → (D : Category ℓD ℓD') → Category _ _
PROFo* C ℓS D = FUNCTOR (C ^op) (FUNCTOR D (SET ℓS))

_*-[_]-o_ : (C : Category ℓC ℓC') → ∀ ℓS → (D : Category ℓD ℓD') → Type _
C *-[ ℓS ]-o D = PROF*o C ℓS D .ob

_o-[_]-*_ : (C : Category ℓC ℓC') → ∀ ℓS → (D : Category ℓD ℓD') → Type _
C o-[ ℓS ]-* D = PROFo* C ℓS D .ob
