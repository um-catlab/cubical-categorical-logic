...
module Gluing.CartesianCategory.BoolNatCanonicity.Forded where
...
open import Cubical.Categories.Constructions.Free.CartesianCategory.Forded as FreeCC
...
module _ where
  ...
  private
    ...
    S = FreeCC.elimLocal ×QUIVER Pts EqSETᴰCCⱽ (mkElimInterpᴰ
  ...
  ⟦-⟧SET = FreeCC.rec ×QUIVER SETCC (mkElimInterpᴰ
