module HyperDoc.Operational.TransitionSystem where 
...
TSysCat .id = idSysHom
TSysCat ._⋆_ = _∘TS_
TSysCat .⋆IdL f = TSysMap≡ refl
TSysCat .⋆IdR f = TSysMap≡ refl
TSysCat .⋆Assoc f g h = TSysMap≡ refl
TSysCat .isSetHom = {!   !}
